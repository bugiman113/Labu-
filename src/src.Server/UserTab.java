...
public class UserTab {
    private static String URL = "jdbc:postgresql://pg:5432/studs";//"jdbc:h2:file:C:\\Us\\User";
    ...
    public static void adduser(String username1,String password1) throws SQLException {
            PreparedStatement preparedStatement = null;
            Connection dbConnection2= null;
            String answer ="";
            String sqlStatement = "INSERT INTO usertable (NAME,PASSWORD) VALUES (?,?);";
