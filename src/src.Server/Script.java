...
public class Script {
    ...
    public StringBuilder script(String filik,long us) throws JAXBException {
                    ...
                    try {
                        ...
                        switch (k) {
                            ...
                            case "update_id":
                                ...
                                int p =insert_key4(scan, filik, i,us);
    ...
    public void insert_key3(Scanner scan, String filik, int sk,Long us) throws FileNotFoundException, JAXBException, SQLException {
        int ik = 1;
        int skk = sk;
        ...
        scanner.nextLine();
        SpaceMarine abc = new SpaceMarine(name, new Coordinates(x, y), fl, bool, fl2, categ1, new Chapter(name2.trim(), name3.trim(), inter));
        AddTable.add(abc,us);
    }

    public int insert_key4(Scanner scan, String filik, int sk, long us) throws FileNotFoundException, JAXBException, SQLException {
        int ik = 1;
        int skk = sk;
        Scanner scanner = new Scanner(new File(filik));
        String date = new String();
