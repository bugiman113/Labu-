...
public class Collection {
    ...
    public static ZonedDateTime time;
        public static HashMap<String, String> chet() throws SQLException {
            ...
            String selectTableSQL = "SELECT ID,NAME,X,Y,HEALTH,LOYAL,HEIGHT,CATEGORY,CHAPTERNAME,PARENTLEGION,MARINESCOUNT,US,COLOR from spacemarine";
            try {
                ...
                while (rs.next()) {
                    ...
                    int color = rs.getInt(13);
                    marineMap.put(key,new SpaceMarine(name, new Coordinates(x, y), fl, bool, fl2, categ, new Chapter(name2, name3, inter),id,us,color));
                    key++;
                }
