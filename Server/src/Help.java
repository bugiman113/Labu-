public class Help {
    public String help() {
        ...
        builder.append("info: вывести в стандартный поток вывода информацию о коллекции!");
        ...
        builder.append("execute_script (file_name): считать и исполнить скрипт из указанного файла.!");
        ...
        builder.append("min_by_creation_date: вывести объект из коллекции, значение поля creationDate которого является минимальным!");
        builder.append("max_by_coordinates: вывести объект из коллекции, значение поля coordinates которого является максимальным!");
